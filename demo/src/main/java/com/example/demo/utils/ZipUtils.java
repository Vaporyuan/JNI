...
import java.io.RandomAccessFile; // add
...
public abstract class ZipUtils {
    ...
    private static final int ZIP64_EOCD_LOCATOR_SIG_REVERSE_BYTE_ORDER = 0x504b0607; // add

    private static final int UINT16_MAX_VALUE = 0xffff;

    /**
     * -------------------------copy from android.util.apk.ZipUtils, by tonnay----------------------
     *
     ...
     */
    public static Pair<ByteBuffer, Long> findZipEndOfCentralDirectoryRecords(RandomAccessFile zip)
            throws IOException {
