...
public class ApkSignatureSchemeV2VerifierEx {
    ...
    private static final int UBX_APK_SIGNATURE_SCHEME_V2_BLOCK_ID = 0x7109871b;
    ...
    private static ByteBuffer findApkSignatureSchemeV2Block(ByteBuffer apkSigningBlock)
        ...
        while (pairs.hasRemaining()) {
            ...
            int id = pairs.getInt();
            if (id == UBX_APK_SIGNATURE_SCHEME_V2_BLOCK_ID) {
    ...
    public static Pair<ByteBuffer, Long> findUbxApkSignatureSchemeV3Block(ByteBuffer apkSigningBlock, int signDataBlockID)
            throws SignatureNotFoundException {
        checkByteOrderLittleEndian(apkSigningBlock);
        // FORMAT:
        // OFFSET       DATA TYPE  DESCRIPTION
    ...
    /**
     * get the SGN Data from UBX apk file
     *
     * @param apkFile
     *
     * @return the InputStream of SGN Data
     */
    public static InputStream getUbxSgnData(String apkFile, int signDataBlockID) throws IOException, SignatureNotFoundException {
        ...
        try {
            ...
            ByteBuffer apkSignatureSchemeV3Block = findUbxApkSignatureSchemeV3Block(apkSigningBlock, signDataBlockID).first;
            apkSignatureSchemeV3Block.position(31 /*8+4+15+4 means: length + tag + magic + sign data len*/);
            byte[] sgnBytes = new byte[apkSignatureSchemeV3Block.capacity() - 31];
            apkSignatureSchemeV3Block.get(sgnBytes, 0, apkSignatureSchemeV3Block.capacity() - 31);
